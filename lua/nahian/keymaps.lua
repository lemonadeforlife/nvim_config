...
key("n", "<leader>x", ":close<CR>", opts)
key("n", "<leader>e", ":NvimTreeToggle<CR>", opts)
key("n", "<leader>t", ":ToggleTerm<CR>", opts)
key("n", "<leader>s", ":w<CR>", opts)
key("n", "<leader>v", ":vsplit<CR>", opts)
key("n", "<leader>h", ":split<CR>", opts)
key("n", "<leader>o", "o<esc>", opts)
key("n", "<leader>O", "O<esc>", opts)
-- Resize with arrows
